...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/icechart-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12362&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/icechart-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `icechart` can be installed with:

```
conda install icechart
```

It is possible to list all of the versions of `icechart` available on your platform with:
